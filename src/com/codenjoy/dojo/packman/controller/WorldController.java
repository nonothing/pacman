...
public class WorldController implements KeyListener, ActionListener {
    ...
    public WorldController(World world, WorldRenderer view, MenuController menuController, boolean isSound) {
    ...
    public void startGame(boolean isSound) {
        ...
        world.setSound(isSound);
        world.playBackground();
        if(world.isVictory()){
            world.newGame();
        }
    }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        case KeyEvent.VK_Y:
            ...
            world.newGame();
            startGame(menuController.isSound());
            }
            break;
        case KeyEvent.VK_N:
            if(world.isGameOver() || world.isVictory()){
